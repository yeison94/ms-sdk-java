...
public class ApiTest {
    ...
    public void t02FindDeviceByUser() {
        ...
        try {
            //BEGIN-SNIPPET: api_user_devices
    ...
    public void t03SendMessage() {
        try {
            ...
            //BEGIN-SNIPPET: api_send_message
            List<Device> devices = api.findDeviceByUser(USER_CODE);
    ...
    public void t06FindTemplatesByUser() {
        ...
        try {
            //BEGIN-SNIPPET: api_user_templates
    ...
    public void t07FindTemplateByCode() {
        try {
            //BEGIN-SNIPPET: api_find_template
    ...
    public void t16CreateDocument() throws Exception {
        ...
        try {
            ...
            //BEGIN-SNIPPET: api_create_document
            Message message = new Message();
        ...
        try{
            //BEGIN-SNIPPET: api_create_document_poll
            int count = 100;
            String status = null;
            while (count > 0) {
                count--;
    ...
    public void t17CreateMessageWithTemplate() throws Exception {
        ...
        try {
            //BEGIN-SNIPPET: api_send_message_template
            Message message = new Message();
