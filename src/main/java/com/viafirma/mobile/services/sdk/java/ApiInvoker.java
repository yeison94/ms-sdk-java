...
public class ApiInvoker {
	...
	public String invokeAPI(String host, String consumerKey, String consumerSecret, String token, String tokenSecret, String path, String method, Map<String, String> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType) throws ApiException {
		...
		//TODO Check "HAMC-SHA1" Signature
		try {
			String resp = response.getEntity(String.class);
			InputStream input = response.getEntityInputStream();
			//byte[] data = IOUtils.toByteArray(input);
			String signature = calculateRFC2104HMAC(resp.getBytes(), "12345");
			response.getHeaders().get("Signature-Body").get(0).equals(signature);
	...
	public String calculateRFC2104HMAC(byte[] data, String key) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
